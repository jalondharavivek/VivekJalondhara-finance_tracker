...
const transactionSlice = createSlice({
  ...
  reducers: {
    ...
    edittransactiondata(state, action) {
      ...
      console.log(editdata,"vivekkkkkk01");
      const editid = action.payload.id;
      console.log(editid,"vivekkkkkk012");
      console.log();
      let index = state.findIndex((x) => x.id === editid);
      console.log(index,"vivekkkkkk013");
...
export const { transactondataadd, edittransactiondata, deletetransactiondata } =
